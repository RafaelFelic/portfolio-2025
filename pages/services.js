  ...
  return (
    <main className="min-h-screen flex flex-col justify-center items-center text-gray-200 px-4 overflow-x-hidden">
      ...
      <div className="max-w-6xl w-full mx-auto">
        ...
        {/* Services Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-2 px-2 md:px-4 items-stretch">
          ...
          >
            <div className="block h-full cursor-pointer">
              <div className="group relative bg-gray-800/40 backdrop-blur-sm rounded-xl p-5 h-full hover:bg-gray-700/40 transition-all duration-300 border border-gray-700/50 hover:border-blue-500/50 flex flex-col hover:transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10">
                <div className="mb-2">
                  ...
                  <p className="text-gray-400 mb-3 line-height-relaxed">
                    Engaging, responsive, and tailored to your brand. I build
                    fast, SEO-friendly websites using modern frameworks.
                  </p>
                </div>
                <div className="mt-auto w-fit inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-medium text-sm">
                  Learn More
                  <svg
          ...
          {/* Service Card: High-Converting Landing Pages */}
          <Link
            href={{
              pathname: "/portfolio",
          ...
          >
            <div className="block h-full cursor-pointer">
              <div className="group relative bg-gray-800/40 backdrop-blur-sm rounded-xl p-5 h-full flex flex-col hover:bg-gray-700/40 transition-all duration-300 border border-gray-700/50 hover:border-blue-500/50 hover:transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10">
                <div className="mb-2">
                  <div className="w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center mb-2 group-hover:bg-blue-500/30 transition-all duration-300">
                    <svg
                      className="w-6 h-6 text-blue-400"
                  ...
                  <p className="text-gray-400 mb-3 line-height-relaxed">
                    Fuel your campaigns with landing pages optimized for clear
                    CTAs and maximum conversions.
                  </p>
                </div>
                <div className="mt-auto w-1/2 inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-medium text-sm">
                  Learn More
                  <svg
                    className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform duration-300"
                    fill="none"
              ...
              <div className="group relative bg-gray-800/40 backdrop-blur-sm rounded-xl p-5 h-full flex flex-col hover:bg-gray-700/40 transition-all duration-300 border border-gray-700/50 hover:border-blue-500/50 hover:transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10">
                <div className="mb-2">
                  ...
                  <p className="text-gray-400 mb-3 line-height-relaxed">
                    ...
                    on-page optimization and performance.
                  </p>
                </div>
                <div className="mt-auto w-1/2 inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-medium text-sm">
                  Learn More
            ...
            <div className="block h-full cursor-pointer">
              <div className="group relative bg-gray-800/40 backdrop-blur-sm rounded-xl p-5 h-full flex flex-col hover:bg-gray-700/40 transition-all duration-300 border border-gray-700/50 hover:border-blue-500/50 hover:transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10">
                <div className="mb-2">
                  ...
                  <p className="text-gray-400 mb-3 line-height-relaxed">
                    Branding, logos, marketing materials, and more to elevate
                    your visual identity and strengthen brand presence.
                  </p>
                </div>
                <div className="mt-auto w-1/2 inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-medium text-sm">
                  Learn More
